...
public class PharmacyController {
  ...
  public Response acceptPrescription(
    ...
    log.info(
        ...
        taskId,
        accessCode);
    return new AcceptUseCase(pharmacy).acceptPrescription(taskId, accessCode);
  }
  ...
  public Response rejectPrescription(
    ...
    log.info(
        ...
        taskId,
        accessCode);
    return new RejectUseCase(pharmacy).rejectPrescription(taskId, accessCode, secret);
  }
  ...
  public Response abortPrescription(
    ...
    return new AbortUseCase(pharmacy).abortPrescription(taskId, accessCode, secret);
  }
