...
import de.gematik.test.erezept.remotefdv.task.AssignPrescriptionToPharmacy;
...
public class PrescriptionAssignmentSteps {
  ...
  public void whenAssignPrescriptionViaDispReq(String userName, String order, String pharmacyName) {
    ...
    when(theAppUser)
        .attemptsTo(AssignPrescriptionToPharmacy.fromStack(order).toPharmacy(thePharmacy));
  }
}
