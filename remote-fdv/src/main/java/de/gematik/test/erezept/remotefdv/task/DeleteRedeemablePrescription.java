...
public class DeleteRedeemablePrescription implements Task {
  ...
  public <T extends Actor> void performAs(T actor) {
    ...
    assertNotEquals(Prescription.StatusEnum.CANCELLED, prescriptionBundle.getStatus());
    client.sendRequest(PatientRequests.deletePrescriptionById(dmc.getTaskId().getValue()));
    val prescriptionBundle2 = actor.asksFor(ReadPrescription.withTaskId(dmc.getTaskId()));
    assertTrue(prescriptionBundle2.isEmpty());
