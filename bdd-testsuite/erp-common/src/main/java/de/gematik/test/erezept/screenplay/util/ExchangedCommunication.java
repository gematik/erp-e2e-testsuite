...
public class ExchangedCommunication {
  ...
  public static ErxCommunicationBuilder from(ErxCommunication com) {
    return new ErxCommunicationBuilder(com);
  }

  public static FdvCommunicationBuilder sentBy(Actor fdvPatient) {
    val egkAbility = SafeAbility.getAbility(fdvPatient, ProvideEGK.class);
    return sentBy(fdvPatient.getName(), egkAbility);
  }

  public static FdvCommunicationBuilder sentBy(String senderActorName, ProvideEGK egkAbility) {
    return sentBy(senderActorName, egkAbility.getKvnr());
  }

  public static FdvCommunicationBuilder sentBy(String senderActorName, KVNR kvnr) {
