...
public class EuConsentGetCommand extends BaseCommand<EuConsentBundle> {

  public EuConsentGetCommand() {

    super(EuConsentBundle.class, HttpRequestMethod.GET, "Consent");
