...
*/
public class EuGrantAccessGetCommand extends BaseCommand<EuAccessPermission> {

  public EuGrantAccessGetCommand() {
    super(
        EuAccessPermission.class,
        HttpRequestMethod.GET,
        "access-permission"); // "$read-eu-access-permission"
  }

  @Override
  public String getRequestLocator() {
    return "/$read-eu-access-permission";
  }
