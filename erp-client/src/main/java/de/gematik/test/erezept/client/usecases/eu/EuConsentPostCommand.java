...
public class EuConsentPostCommand extends BaseCommand<EuConsent> {
  ...
  public EuConsentPostCommand(KVNR kvnr) {
    this(EuConsentBuilder.forKvnr(kvnr).build());
  }

  public EuConsentPostCommand(EuConsent requestBody) {
    super(EuConsent.class, HttpRequestMethod.POST, "Consent");
