...
public class ChargeItemPutCommand extends BaseCommand<Resource> {

  private final ErxChargeItem body;

  public ChargeItemPutCommand(ErxChargeItem body) {
    super(Resource.class, HttpRequestMethod.PUT, "ChargeItem", body.getPrescriptionId().getValue());
    this.body = body;
  }
