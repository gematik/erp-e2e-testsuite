...
import de.gematik.test.erezept.eml.fhir.profile.EpaMedicationCodeSystem;
...
@Getter
public enum EpaDrugCategory implements FromValueSet {
  C_00(
  ...
  public Extension asExtension() {
    return new Extension(
        EpaMedicationStructDef.DRUG_CATEGORY_EXT.getCanonicalUrl(), this.asCoding());
  }
