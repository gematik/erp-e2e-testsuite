...
class EpaOpCancelPrescriptionTest {
  ...
  static void setup() {
    ...
    epaOpCancelPrescription =
        fh.decode(EpaOpCancelPrescription.class, EPA_OP_CANCEL_PRESC_AS_STRING);
  }

  @Test
  void shouldGetEpaAuthoredOnDateCorrect() {
    assertEquals(
        new Date(2025 - 1900, Calendar.JANUARY, 22), epaOpCancelPrescription.getEpaAuthoredOn());
  }
