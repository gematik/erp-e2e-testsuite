...
import de.gematik.test.erezept.fhir.r4.kbv.KbvIngredientComponent;
...
public class KbvIngredientComponentBuilder {
  ...
  public static KbvIngredientComponentBuilder builder() {
    return new KbvIngredientComponentBuilder();
  }

  public KbvIngredientComponent build() {
    KbvIngredientComponent ingredient = new KbvIngredientComponent();
    ...
    Optional.ofNullable(this.ingredientStrength)
        .ifPresent(strength -> fillMissingIngredientStrength(ingredientStrength, ingredient));
  ...
  private void fillMissingIngredientStrength(
      Ratio ingredientStrength, KbvIngredientComponent ingredientComponent) {
    ...
    ingredientComponent
        ...
        .addExtension(INGREDIENT_DARREICHUNGSFORM.asStringExtension(darreichungsForm));
  }

  public KbvIngredientComponentBuilder darreichungsform(String form) {
    this.darreichungsForm = form;
    return this;
  }

  public KbvIngredientComponentBuilder textInCoding(String text) {
    this.itemText = text;
    return this;
  }

  public KbvIngredientComponentBuilder ask(ASK ask) {
    this.ingredientList.add(ask.asCoding());
    return this;
  }

  public KbvIngredientComponentBuilder snomed(String snomed) {
    this.ingredientList.add(CommonCodeSystem.SNOMED_SCT.asCoding(snomed));
    return this;
  }

  public KbvIngredientComponentBuilder ingredientStrength(
  ...
  public KbvIngredientComponentBuilder ingredientStrength(Ratio ingredientStrength) {
    this.ingredientStrength = ingredientStrength;
    return this;
  }

  public KbvIngredientComponentBuilder ingredientStrength(
      int numerator, String numUnit, int denominator, String denomUnit) {
    return ingredientStrength(
        new Quantity(numerator), new Quantity(denominator), numUnit, denomUnit);
  }

  public KbvIngredientComponentBuilder ingredientStrength(
      Quantity numerator, Quantity denominator, String unit) {
  ...
  public KbvIngredientComponentBuilder atc(ATC atc) {
    this.ingredientList.add(atc.asCoding());
    return this;
  }

  public KbvIngredientComponentBuilder pzn(PZN pzn) {
    this.ingredientList.add(pzn.asCoding());
    return this;
  }

  public KbvIngredientComponentBuilder pzn(PZN pzn, String name) {
    this.ingredientList.add(pzn.asCoding().setDisplay(name));
    return this;
  }

  public KbvIngredientComponentBuilder dontFillMissingIngredientStrength() {
    this.refillStrengthAbsentReason = false;
    return this;
  }

  public KbvIngredientComponentBuilder withStrengthNumSystem() {
    return withStrengthNumSystem(CommonCodeSystem.UCUM);
  }

  public KbvIngredientComponentBuilder withStrengthNumSystem(WithCodeSystem strengthNumSystem) {
    this.strengthNumSystem = strengthNumSystem;
    return this;
  }

  public KbvIngredientComponentBuilder strengthAmountText(String quantityFreetext) {
    this.strengthFreetext =
        KbvItaErpStructDef.MEDICATION_INGREDIENT_AMOUNT.asStringExtension(quantityFreetext);
    return this;
  }

  public KbvIngredientComponentBuilder withKbvDarreichungsform(
  ...
  public KbvIngredientComponentBuilder ingredItemCodingText(String ingredItemCodingText) {
