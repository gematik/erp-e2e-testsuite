...
// nach "https://www.cida.de/wp-content/uploads/sites/2/2020/07/IK_Liste_Krankenkassen.pdf" 26.01.23
// 14h

public enum InsuranceCoverageBG implements InsuranceCoverage {
  BG_BAU_SUED("BG BAU Region Süd", "81241 München, Am Knie 6", "120991009"),
  ...
  BG_GEM_UNF_OLD("BG Gem.Unf.Vers.Oldenburg", "26122 Oldenburg, Gartenstr.9", "120391786"),
  BG_GEM_UNF_NDR("BG Gemeindeunfall NDR Sach.", "30519 Hannover, Am Mittelfelde 169", "120391764"),
  BG_GEM_UNF(
  ...
  BG_HANDEL_MUIMCHEN(
      "BG Handel und Warendistribution München", "80335 München, LINPRUNSTR.52", "120991167"),
  BG_HANDEL_BERLIN(
  ...
  HOLZ_METALL_HANNOVER(
      "BG Holz und Metall Hannover", "30173 Hannover, Seligmann Allee 4", "120392377"),
  HOLZ_METALL_DUESSELDORF(
      "BG Holz und Metall Düsseldorf", "40010 Düsseldorf, Kreuzstr. 54", "120590264"),
  HOLZ_METALL_KOELN("BG Holz und Metall Köln", "50829 Köln, Hugo-Eckener-Str. 20", "120590275"),
  HOLZ_METALL_MAINZ("BG Holz und Metall Mainz", "55124 Mainz, Isaac-Fulda-Allee 18", "120790391"),
  HOLZ_METALL_MUINCHEN("BG Holz und Metall München", "81241 München, Am Knie 8", "120990623"),
  HOLZ_METALL_BERLIN("BG Holz und Metall Berlin", "10825 Berlin, Innsbrucker Strasse", "121590028"),
  HOLZ_METALL_ERFURT(
      "BG Holz und Metall Erfurt", "99097 Erfurt, Lucas-Chranach-Platz", "121690085"),
  HUETTEN_WALZWERKE("BG Hütten-Walzwerke", "44263 Dortmund, Semerteichstr. 98", "120590208"),
  LAND_FORSTWIRTSCHAFT("BG LAND-U.FORSTWIRTSCHAFT", "64289 Darmstadt, BARTNINGSTR.57", "120692791"),
  LANDWIRTSCHAFT_SAARLAND(
      "BG LANDWIRTSCHAFT SAARL.", "66121 Saarbrücken, HEINERSTR. 2-4", "121092811"),
  LANDESUNFALLKASSE_NDR_SACH(
      "BG Landesunfallk.NDR Sach.", "30519 Hannover, Am Mittelfelde 169", "120391968"),
  ...
  LANDWIRTSCHAFT_MUINCHEN("BG Landwirtschaft", "81673 München, Neumarkter Str. 35", "120992863"),
  ...
  METALL_NORDD(
      "Berufsgenossenschaft Metall Nordd.",
      "20149 Hamburg, Rothenbaumchaussee Chaussee 145",
      "120491958"),
  METALL_SUEDD("BG Metall Südd.", "70563 Stuttgart, Vollmöllerstr. 11", "120890369"),
  NAHRUNG_GASTSTAETTEN("BG NAHRUNG-GASTSTAETTEN", "68165 Mannheim, DYNAMO-STR. 7-9", "120890780"),
  ...
  POST_TELEKOM("BG Unfallk.Post u. Telekom", "72072 Tübingen, Europaplatz 2", "120892305"),
  UNFALLKASSE_BERLIN("BG Unfallkasse Berlin", "12277 Berlin, Culemeyerstr. 2", "121191913"),
  UNFALLKASSE_BRB(
  ...
  UNFALLKASSE_MECKLENBURG(
      "BG Unfallkasse Mecklenb.", "19053 Schwerin, Wismarsche Str. 199", "121390015"),
  ...
  VERKEHR_WUPPERTAL("BG Verkehr Wupppertal", "42103 Wuppertal, Aue 96", "120591334"),
  ...
  VERWALTUNG_MAINZ("120791212BG Verwaltung", "55124 Mainz, Isaac-Fulda-Allee 3", "120791212"),
  ...
  InsuranceCoverageBG(String naming, String contact, String iknr) {
    this.naming = naming;
