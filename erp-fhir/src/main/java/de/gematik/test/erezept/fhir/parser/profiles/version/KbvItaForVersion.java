...
public enum KbvItaForVersion implements ProfileVersion<KbvItaForVersion> {
  V1_0_3("1.0.3", LocalDate.of(1970, Month.JANUARY, 1), LocalDate.of(2023, Month.JULY, 31)),
  ...
  private final CustomProfiles customProfile = CustomProfiles.KBV_ITA_FOR;

  public static KbvItaForVersion getDefaultVersion() {
    return ProfileVersion.getDefaultVersion(KbvItaForVersion.class, CustomProfiles.KBV_ITA_FOR);
  }
}
