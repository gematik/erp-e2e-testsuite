...
@Getter
@AllArgsConstructor
public enum KbvCodeSystem implements WithCodeSystem {
  BASE_IDENTIFIER_TYPE("https://fhir.kbv.de/CodeSystem/KBV_CS_Base_identifier_type"),
  STATUS_CO_PAYMENT("https://fhir.kbv.de/CodeSystem/KBV_CS_FOR_StatusCoPayment"), // the new one!
  ...
  SFHIR_BMP_DOSIEREINHEIT("https://fhir.kbv.de/CodeSystem/KBV_CS_SFHIR_BMP_DOSIEREINHEIT"),
  ;
