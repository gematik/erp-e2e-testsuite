...
public class SupplyRequestReference extends CustomReferenceProvider {

  public SupplyRequestReference(String referenceValue) {
    super("SupplyRequest", referenceValue);
  }
