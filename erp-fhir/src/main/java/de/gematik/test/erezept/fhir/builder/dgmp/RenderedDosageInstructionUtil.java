...
public class RenderedDosageInstructionUtil {
  ...
  public static Extension createGeneratorExtension() {
    ...
    ex.addExtension().setUrl("algorithmVersion").setValue(new StringType("1.0.1"));
    ex.addExtension().setUrl("language").setValue(new CodeType("de-DE"));
    return ex;
  }
   ...
   * <li>DayOfWeek + When: "montags 1-0-1-0 Stück; mittwochs 2-1-2-0 Stück"
   *
   ...
   *
   * @param dosages List with interval and timing information
   * @return Formatted text like "montags 1-0-1-0 Stück; mittwochs 2-1-2-0 Stück"
   */
