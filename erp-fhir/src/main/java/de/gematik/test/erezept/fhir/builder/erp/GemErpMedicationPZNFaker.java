...
public class GemErpMedicationPZNFaker {
  ...
  public GemErpMedicationPZNFaker withPzn(PZN pzn) {
    builderConsumers.put("pzn", b -> b.pzn(pzn));
    return this;
  }

  public GemErpMedicationPZNFaker withPzn(PZN pzn, String medicationName) {
    builderConsumers.put("pzn", b -> b.pzn(pzn, medicationName));
    return this;
  }

  public GemErpMedicationPZNFaker withStandardSize(StandardSize normgroesse) {
    builderConsumers.put("normgroesse", b -> b.normgroesse(normgroesse));
    return this;
  }

  public GemErpMedicationPZNFaker withDarreichungsform(Darreichungsform darreichungsform) {
    builderConsumers.put("darreichungsform", b -> b.darreichungsform(darreichungsform));
    return this;
  }

  public GemErpMedicationPZNFaker withVaccineFlag(boolean isVaccine) {
    builderConsumers.put("vaccine", b -> b.isVaccine(isVaccine));
    return this;
  }

  public GemErpMedicationPZNFaker withAmount(long numerator) {
    builderConsumers.put("amount", b -> b.amount(numerator));
    return this;
  }

  public GemErpMedicationPZNFaker withAmount(long numerator, String unit) {
    builderConsumers.put("amount", b -> b.amount(numerator, unit));
    return this;
  }

  public GemErpMedicationPZNFaker withLotNumber(String lotNumber) {
