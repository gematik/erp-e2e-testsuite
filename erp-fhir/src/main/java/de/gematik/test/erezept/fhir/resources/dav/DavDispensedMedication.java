...
public class DavDispensedMedication extends MedicationDispense {
  ...
  public static DavDispensedMedication fromMedicationDispense(MedicationDispense adaptee) {
    val dispensed = new DavDispensedMedication();
    adaptee.copyValues(dispensed);
    return dispensed;
  }

  public static DavDispensedMedication fromMedicationDispense(Resource adaptee) {
