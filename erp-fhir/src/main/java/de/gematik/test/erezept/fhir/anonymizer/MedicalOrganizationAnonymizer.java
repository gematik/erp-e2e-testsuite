...
public class MedicalOrganizationAnonymizer implements Anonymizer<KbvMedicalOrganization> {

  @Override
  public Class<KbvMedicalOrganization> getType() {
    return KbvMedicalOrganization.class;
  }

  @Override
  public void anonymize(AnonymizerContext ctx, KbvMedicalOrganization resource) {
