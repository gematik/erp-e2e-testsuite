...
public enum KbvItaErpVersion implements ProfileVersion<KbvItaErpVersion> {
  ...
  private final CustomProfiles customProfile = CustomProfiles.KBV_ITA_ERP;

  public static KbvItaErpVersion getDefaultVersion() {
    return ProfileVersion.getDefaultVersion(KbvItaErpVersion.class, CustomProfiles.KBV_ITA_ERP);
  }
}
