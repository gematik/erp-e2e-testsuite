  ...
  public IgnoreMissingValueSetValidationSupport(
    ...
    for (String codeSystemToIgnore : codeSystemsToIgnore) {
      this.codeSystemsToIgnore.put(
          codeSystemToIgnore,
          String.format("This module has no support for code system %s", codeSystemToIgnore));
    }
  }
