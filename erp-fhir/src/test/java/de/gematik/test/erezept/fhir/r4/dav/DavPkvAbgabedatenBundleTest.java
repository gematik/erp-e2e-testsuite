...
class DavPkvAbgabedatenBundleTest extends ErpFhirParsingTest {
  ...
  void testEncodeSingleValidBundle() {
    ...
    val expectedPrescriptionId = PrescriptionId.from("200.100.000.000.081.90");
    ...
    val bundle = parser.decode(DavPkvAbgabedatenBundle.class, content);
  ...
  void shouldDecodeWithoutExpectedType() {
    ...
    assertEquals(DavPkvAbgabedatenBundle.class, bundle.getClass());
  }
  ...
  void shouldCastFromResource() {
    ...
    assertDoesNotThrow(() -> DavPkvAbgabedatenBundle.fromBundle(bundleResource));
  }
}
