...
public class PrescriptionToDispenseStrategy {
  ...
  public void teardown() {
    if (this.dequeue == DequeStrategyEnum.FIFO) {
      prescriptionManager.consumeOldestAcceptedPrescription();
    } else {
      prescriptionManager.consumeLastAcceptedPrescription();
    }
  }

  public static Builder withDequeue(DequeStrategyEnum dequeue) {
  ...
  public static class Builder {
    ...
    public Builder(DequeStrategyEnum dequeue) {
    ...
    private ErxAcceptBundle getPrescriptionToDispense(
        ManagePharmacyPrescriptions prescriptionManager) {
      ErxAcceptBundle prescriptionToDispense;
      if (this.strategy.dequeue == DequeStrategyEnum.FIFO) {
        prescriptionToDispense = prescriptionManager.getOldestAcceptedPrescription();
      } else {
        prescriptionToDispense = prescriptionManager.getLastAcceptedPrescription();
      }
      return prescriptionToDispense;
    }
  }
}
