...
public class HisSentCommunications implements Question<Boolean> {
  ...
  public static class Builder {
    ...
    public HisSentCommunications fromQueueStillExists(String order) {
      return fromQueueStillExists(DequeStrategy.fromString(order));
    }

    public HisSentCommunications fromQueueStillExists(DequeStrategy deque) {
      return new HisSentCommunications(
          (sent, fetched) -> {
    ...
    public HisSentCommunications expectingAll() {
      return new HisSentCommunications((sent, fetched) -> fetched.size() == sent.size());
    }

    public HisSentCommunications noneExistAnymore() {
      return new HisSentCommunications((sent, fetched) -> fetched.isEmpty());
    }
  }
}
