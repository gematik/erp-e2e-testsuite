...
public class LosePrescription implements Task {

  private final DequeStrategy deque;

  public LosePrescription(DequeStrategy deque) {
    this.deque = deque;
  }

  public static LosePrescription fromStack(String deque) {
    return fromStack(DequeStrategy.fromString(deque));
  }

  public static LosePrescription fromStack(DequeStrategy deque) {
    return new LosePrescription(deque);
  }
