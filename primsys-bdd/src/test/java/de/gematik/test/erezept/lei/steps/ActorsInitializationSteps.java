...
public class ActorsInitializationSteps {
  ...
  public void initPharmacy(String pharmName) {
    ...
    val erpClient = ErpClientFactory.createErpClient(config.getActiveEnvironment(), pharmConfig);
    val useErpClient = UseTheErpClient.with(erpClient, stopwatch);
    useErpClient.authenticateWith(useKonnektor);
    // assemble the screenplay
    val thePharmacy = OnStage.theActorCalled(pharmName);
    thePharmacy.describedAs(pharmConfig.getDescription());
    ...
    givenThat(thePharmacy).can(ProvideApoVzdInformation.withName(pharmConfig.getApoVzdName()));
  ...
  public void initApothecary(String pharmacistName) {
    ...
    thePharmacist.describedAs(apothecaryConfig.getDescription());
  ...
  public void initDoctor(String docName) {
    ...
    theDoctor.describedAs(docConfig.getDescription());
  ...
  public void initPatient(String insuranceType, String patientName) {
    ...
    val egkAbility = ProvideEGK.sheOwns(egk);
    ...
    val provideBaseData =
        ProvidePatientBaseData.forPatient(egkAbility.getKvnr(), patientName, insuranceType);
    ...
    givenThat(thePatient).can(egkAbility);
