...
public class CloseDigaPrescriptionWithoutRedeemCode implements Task {
  ...
  public <T extends Actor> void performAs(T actor) {
    ...
    // build dispensation
    val md =
        ErxMedicationDispenseDiGABuilder.forKvnr(
                SafeAbility.getAbility(receiver, ProvideEGK.class).getKvnr())
            .performerId(smcb.getTelematikID())
            .note("Formfehler in der Schreibweise, daher wird die Verordnung zurückgewiesen")
            .prescriptionId(acceptBundle.getTaskId().toPrescriptionId())
            .build();
  ...
  public static class Builder {
    ...
    public CloseDigaPrescriptionWithoutRedeemCode to(Actor receiver) {
      return new CloseDigaPrescriptionWithoutRedeemCode(this.order, receiver);
    }
  }
}
