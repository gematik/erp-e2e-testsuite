...
Funktionalität: DiGA Anwendungsfälle
  ...
  Szenariogrundriss: Ein Psychotherapeut verschreibt der Versicherten Hanna Bäcker ein EVDGA E-Rezept.
    ...
    Und die GKV Versicherte Hanna Bäcker kann für die letzte EVDGA den Freischaltcode abrufen
  ...
  Szenario: Abgabe ohne Freischaltcode, wenn kein Leistungsanspruch vorliegt
    ...
    Und der Psychotherapeut Finn Stauffenberg der Versicherten Hanna Bäcker ein EVDGA E-Rezept verschreibt
    Wenn die GKV Versicherte Hanna Bäcker ihr letztes ausgestelltes EVDGA E-Rezept ihrem Kostenträger AOK Bremen zuweist
    Dann kann der Kostenträger AOK Bremen das letzte EVDGA E-Rezept der Versicherten Hanna Bäcker akzeptieren
    Und der Kostenträger AOK Bremen kann für die letzte EVDGA der Versicherten Hanna Bäcker Abgabeinformationen ohne Freischaltcode bereitstellen
    Und die GKV Versicherte Hanna Bäcker kann für die letzte EVDGA keinen Freischaltcode abrufen

  @TCID:ERP_EE_WF162_05
  Szenario: Abgabe einer EVDGA als Apotheke
    ...
    Und der Psychotherapeut Finn Stauffenberg der Versicherten Hanna Bäcker ein EVDGA E-Rezept verschreibt
    Wenn die GKV Versicherte Hanna Bäcker ihr letztes ausgestelltes E-Rezept der Apotheke Am Flughafen via Data Matrix Code zuweist
    Dann kann die Apotheke Am Flughafen das letzte EVDGA E-Rezept nicht akzeptieren
  ...
  Szenario: keine zeitnahe Dispensierung durch den Kostenträger
    ...
    Wenn die GKV Versicherte Hanna Bäcker ihr letztes ausgestelltes EVDGA E-Rezept ihrem Kostenträger AOK Bremen zuweist
    Dann kann der Kostenträger AOK Bremen das letzte EVDGA E-Rezept der Versicherten Hanna Bäcker akzeptieren
    Und der Kostenträger AOK Bremen kann für die letzte akzeptierte EVDGA keine zeitnahe Dispensierung durchführen

  @TCID:ERP_EE_WF162_07
  Szenario: Kostenträger darf EVDGA nicht löschen
    Angenommen der Psychotherapeut Finn Stauffenberg hat Zugriff auf seinen HBA und auf die SMC-B der Praxis
    Und der Psychotherapeut Finn Stauffenberg der Versicherten Hanna Bäcker ein EVDGA E-Rezept verschreibt
    Wenn die GKV Versicherte Hanna Bäcker ihr letztes ausgestelltes EVDGA E-Rezept ihrem Kostenträger AOK Bremen zuweist
    Und der Kostenträger AOK Bremen das letzte EVDGA der Versicherten Hanna Bäcker akzeptiert
    Dann kann der Kostenträger AOK Bremen das letzte akzeptierte EVDGA nicht löschen

  @TCID:ERP_EE_WF162_08
  Szenario: Kostenträger darf EVDGA zurückweisen
  ...
  Szenario: Kostenträger erklärt die Ablehnung der DiGA mit Hilfe des Fachdienstes
    ...
    Und der Kostenträger AOK Bremen das letzte EVDGA der Versicherten Hanna Bäcker akzeptiert
    Und der Kostenträger AOK Bremen kann für die letzte EVDGA der Versicherten Hanna Bäcker Abgabeinformationen ohne Freischaltcode bereitstellen
    Dann kann der Kostenträger AOK Bremen für das letzte akzeptierte EVDGA E-Rezept der Versicherten Hanna Bäcker eine Begründung senden
