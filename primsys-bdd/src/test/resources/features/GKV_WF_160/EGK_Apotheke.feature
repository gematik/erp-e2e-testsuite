...
Funktionalität: eGK in der Apotheke
  ...
  Grundlage: Die Ärztin Dr. Straßer verschreibt der Versicherten Günther Angermänn ein E-Rezept als Grundlage für
  die Testszenarien
  ...
  @Afo=A_21558-1
  @Afo=A_22431
  Szenario: E-Rezept mit eGK in der Apotheke einlösen
  Der GKV Versicherte Günther Angermänn will sein E-Rezept mit seiner EGK in der
  öffentlichen Apotheke Am Flughafen einlösen können
  ...
  @Path=happy
  @Afo=A_22431
  Szenario: Apotheke darf über die eGK nur E-Rezepte einsehen die noch nicht eingelöst sind
  Bei diesem Szenario werden dem GKV Versicherten Günther Angermänn zwei E-Rezepte verschrieben.
  Das erste E-Rezepte wird über die Apotheke Am Flughafen mit der eGK eingelöst. Das zweite E-Rezept soll über die
  Apotheke B abgerufen werden. Günther Angermänn will, dass die Apotheke B beim Einlösen
  ...
  Der GKV Versicherte Günther Angermänn will, dass das Einlösen über die eGK protokolliert
  ...
  Der GKV Versicherte Günther Angermänn kann seine E-Rezept nicht in einer Krankenhaus-Apotheke
  mit seiner EGK einlösen, da die Krankenhaus-Apotheken nur mit der eGK keine E-Rezepte abrufen dürfen.

    Angenommen die Apotheke Krankenhaus hat Zugriff auf ihre SMC-B
    Wenn die Apotheke Krankenhaus die E-Rezepte mit der eGK von Aenna Gondern abruft
    Dann kann die Apotheke Krankenhaus die E-Rezepte von Aenna Gondern nicht abrufen, weil Krankenhaus-Apotheken nicht berechtigt sind

  @TCID=ERP_EE_WF160_EGK_APOTHEKE_04
  @Path=bad
  @Afo=A_22432
  Szenario: Das Abrufen von E-Rezepten ohne das zuvor ein aktueller Prüfungsnachweis abgerufen wurde, muss
  vom E-Rezept Fachdienst untersagt werden.
  ...
  @Path=bad
  @Afo=A_22432
  Szenario: E-Rezepte mit eGK in der Apotheke nur mit zeitlich gültigem Prüfnachweis
  ...
  Zugriff auf die E-Rezepte des Versicherten Günther Angermänn.
    ...
    Dann kann die Apotheke Am Flughafen die E-Rezepte von Aenna Gondern nicht abrufen, weil der Prüfungsnachweis nicht gültig ist
