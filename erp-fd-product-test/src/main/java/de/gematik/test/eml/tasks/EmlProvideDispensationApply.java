...
public class EmlProvideDispensationApply implements Task {

  private final KVNR kvnr;

  public static EmlProvideDispensationApply forKvnr(KVNR kvnr) {
    return new EmlProvideDispensationApply(kvnr);
  }
  ...
  public <T extends Actor> void performAs(T actor) {
    ...
    val works = client.setProvideDispensationApply(kvnr);
    if (!works) throw new EpaMockClientException(actor.getName(), "provide dispensation apply");
  }
}
