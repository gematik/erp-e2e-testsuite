...
public class SendCommunication extends ErpAction<ErxCommunication> {
  ...
  public static class Builder {
    ...
    public SendCommunication asReply(CommunicationReplyMessage message) {
      ...
      val communication =
          ErxCommunicationBuilder.builder()
              ...
              .buildReply(message);
      return new SendCommunication(communication, fuzzingMutators);
    }

    public SendCommunication asDispenseRequest(CommunicationDisReqMessage message) {
