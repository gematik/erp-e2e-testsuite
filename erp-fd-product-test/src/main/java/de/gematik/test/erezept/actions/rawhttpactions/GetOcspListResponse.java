...
public class GetOcspListResponse implements Question<HttpResponse<String>> {

  @Override
  public HttpResponse<String> answeredBy(Actor actor) {
    val httpClient = SafeAbility.getAbility(actor, RawHttpAbility.class);
    return httpClient.get("/OCSPList").asString();
  }
}
