...
public class GetEuAccessPermission extends ErpAction<EuAccessPermission> {

  public static GetEuAccessPermission forOneSelf() {
    return new GetEuAccessPermission();
  }

  @Step("{0} ruft seine EU-Zugriffsberechtigung ab")
  @Override
  public ErpInteraction<EuAccessPermission> answeredBy(Actor actor) {
    val cmd = new EuGrantAccessGetCommand();
