...
@DisplayName("Provide Teratogenic Prescription with Consent Test")
@Tag("ProvideEmlPrescriptionAsTPrescription")
@Tag("EpaEml")
public class ProvideTPrescriptionWithConsentIT extends ErpTest {
  ...
  private KbvErpMedication getMedication(String medicationType) {
    return switch (medicationType) {
      ...
      case MEDICATION_FREITEXT -> KbvErpMedicationFreeTextFaker.builder()
          ...
          .withDosageForm("Zäpfchen, viel Spaß")
          .withVaccine(false)
          .withFreeText("<Anreihung pharmakologischer Fachbegriffe>")
          .fake();
