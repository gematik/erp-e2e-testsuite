...
public class ActivateInvalidPractitionerAnrAndZanrIT extends ErpTest {
  ...
  /**
   * Warning ResponseHeader ist in A_24033 genauer spezifiziert und wird nach <a
   * href="https://datatracker.ietf.org/doc/html/rfc2616#section-14.46">RFC-2616</a> "Warning":
   *
  ...
  void activateValidAnrZanrInPractitioner(
    ...
    val doc = this.getDoctorNamed(doctors.getName());
    patient.changeCoverageInsuranceType(insuranceType);
