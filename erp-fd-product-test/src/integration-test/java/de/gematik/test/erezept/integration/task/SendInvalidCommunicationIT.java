...
public class SendInvalidCommunicationIT extends ErpTest {
   ...
   */
  @TestcaseId("ERP_SEND_INVALID_COMMUNICATION_01")
  @ParameterizedTest(
      name =
  ...
  void shouldValidatePharmaciesCommunicationWithToLongString(
    ...
    pharma.attemptsTo(
        Verify.that(response2)
            ...
            .and(operationOutcomeContainsInDetailText("Invalid request body", ErpAfos.A_23879))
            .isCorrect());
  }
  ...
  @TestcaseId("ERP_SEND_INVALID_COMMUNICATION_02")
  @ParameterizedTest(
      name =
  ...
  void shouldValidatePatientCommunicationWithToLongString(
    ...
    val response2 =
        patient.performs(
            SendCommunication.to(pharma).forTask(prescTask).asDispenseRequest(disReqMessage));
    patient.attemptsTo(
        Verify.that(response2)
            .withOperationOutcome(ErpAfos.A_23878)
            .and(operationOutcomeContainsInDetailText("Invalid request body", ErpAfos.A_23878))
            .isCorrect());
  }

  @TestcaseId("ERP_SEND_INVALID_COMMUNICATION_03")
  @ParameterizedTest(
      name =
  ...
  @TestcaseId("ERP_SEND_INVALID_COMMUNICATION_04")
  @ParameterizedTest(
      name =
          "[{index}] -> Die Stadtapotheke schickt eine Communication mit invalidem Json-Content mit {0} und SupplyOption {1} an den Versicherten Leonie Hütter!")
  @DisplayName(
  ...
  @TestcaseId("ERP_SEND_INVALID_COMMUNICATION_05_A")
  @ParameterizedTest(
      name =
  ...
  void shouldValidatePharmaciesCommunicationWithIncorrectSupplyOption(
    ...
    val replyMessage =
        new CommunicationReplyMessage(1, "zuwerfen", getRandomString(500), null, null, null);
  ...
  @TestcaseId("ERP_SEND_INVALID_COMMUNICATION_05_B")
  @ParameterizedTest(
      name =
          "[{index}] -> Die Stadtapotheke schickt eine Communication mit invalidem Json-Content mit {0} und SupplyOption {1} an den Versicherten Leonie Hütter!")
  @DisplayName(
  ...
  void shouldValidatePharmaciesCommunicationWithIncorrectSupplyOptionEqualsNoSupplyOption(
    ...
    val replyMessage = new CommunicationReplyMessage(1, "", getRandomString(500), null, null, null);
  ...
  @TestcaseId("ERP_SEND_INVALID_COMMUNICATION_06_A")
  @ParameterizedTest(
      name =
          "[{index}] -> Die Stadtapotheke schickt eine Communication mit invalidem Json-Content mit {0} und SupplyOption 'zuwerfen' an den Versicherten Leonie Hütter!")
  @DisplayName(
  ...
  void shouldValidatePatientCommunicationWithIncorrectSupplyOption(
    ...
    val cDRM2 =
        new CommunicationDisReqMessage(
            1, "zuwerfen", "patientName", null, getRandomString(500), null);
    val response2 =
        patient.performs(SendCommunication.to(pharma).forTask(prescTask).asDispenseRequest(cDRM2));
    patient.attemptsTo(
        Verify.that(response2)
  ...
  @TestcaseId("ERP_SEND_INVALID_COMMUNICATION_06_B")
  @ParameterizedTest(
      name =
          "[{index}] -> Die Stadtapotheke schickt eine Communication mit invalidem Json-Content mit {0} und SupplyOption {1} an den Versicherten Leonie Hütter!")
  @DisplayName(
  ...
  void shouldValidatePatientCommunicationWithIncorrectSupplyOptionAsNull(
    ...
    val prescTask = getTask(assignmentKind);
    val cDRM2 =
        new CommunicationDisReqMessage(1, "", "patientName", null, getRandomString(500), null);
    val response2 =
        patient.performs(SendCommunication.to(pharma).forTask(prescTask).asDispenseRequest(cDRM2));
    patient.attemptsTo(
        Verify.that(response2)
  ...
  @TestcaseId("ERP_SEND_INVALID_COMMUNICATION_07")
  @ParameterizedTest(
      name =
          "[{index}] -> Die Stadtapotheke schickt eine Communication mit invalidem Json-Content mit {0} und SupplyOption {1} an den Versicherten Leonie Hütter!")
  @DisplayName(
  ...
  @TestcaseId("ERP_SEND_INVALID_COMMUNICATION_08")
  @ParameterizedTest(
      name =
          "[{index}] -> Die Stadtapotheke schickt eine Communication mit invalidem Json-Content mit {0} und SupplyOption {1} an den Versicherten Leonie Hütter!")
  @DisplayName(
  ...
  @TestcaseId("ERP_SEND_INVALID_COMMUNICATION_09")
  @ParameterizedTest(
      name =
          "[{index}] -> Die Stadtapotheke schickt eine Communication mit invalidem Json-Content mit {0} und SupplyOption {1} an den Versicherten Leonie Hütter!")
  @DisplayName(
  ...
  @TestcaseId("ERP_SEND_INVALID_COMMUNICATION_10")
  @ParameterizedTest(
      name =
          "[{index}] -> Die Stadtapotheke schickt eine Communication mit invalidem Json-Content mit {0} und SupplyOption {1} an den Versicherten Leonie Hütter!")
  @DisplayName(
  ...
  @TestcaseId("ERP_SEND_INVALID_COMMUNICATION_11")
  @ParameterizedTest(
      name =
          "[{index}] -> Die Stadtapotheke schickt eine Communication mit invalidem Json-Content mit {0} und SupplyOption {1} an den Versicherten Leonie Hütter!")
  @DisplayName(
  ...
  @TestcaseId("ERP_SEND_INVALID_COMMUNICATION_12")
  @ParameterizedTest(
      name =
          "[{index}] -> Die Stadtapotheke schickt eine Communication mit invalidem Json-Content mit {0} und SupplyOption {1} an den Versicherten Leonie Hütter!")
  @DisplayName(
  ...
  @TestcaseId("ERP_SEND_INVALID_COMMUNICATION_13")
  @ParameterizedTest(
      name =
          "[{index}] -> Die Stadtapotheke schickt eine Communication mit invalidem Json-Content mit {0} und SupplyOption {1} an den Versicherten Leonie Hütter!")
  @DisplayName(
