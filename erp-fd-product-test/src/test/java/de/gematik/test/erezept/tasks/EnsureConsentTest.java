...
class EnsureConsentTest {
    ...
    void shouldFailOnOperationOutcomeDuringGet() {
        ...
        val getConsentResponse =
                ErpResponse.forPayload(FhirTestResourceUtil.createOperationOutcome(), ErxConsentBundle.class)
                        .withStatusCode(400)
                        .withHeaders(Map.of())
    ...
    void shouldEnsureConsentIsSet() {
        ...
        val postConsentResponse = ErpResponse.forPayload(mock(ErxConsent.class), ErxConsent.class)
                .withStatusCode(201)
                .withHeaders(Map.of())
                .andValidationResult(FhirTestResourceUtil.createEmptyValidationResult());
    ...
    void shouldEnsureConsentIsUnset() {
        ...
        val postConsentResponse = ErpResponse.forPayload(mock(Resource.class), Resource.class)
                .withStatusCode(201)
                .withHeaders(Map.of())
                .andValidationResult(FhirTestResourceUtil.createEmptyValidationResult());
