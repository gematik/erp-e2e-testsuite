...
class GetCertListResponseTest {
  ...
  void shouldGetResponse() {
    ...
    wiremockExtension.stubFor(
        get(urlEqualTo("/CertList")).willReturn(aResponse().withStatus(200).withBody(body)));
    val response = assertDoesNotThrow(() -> actor.asksFor(new GetCertListResponse()));
