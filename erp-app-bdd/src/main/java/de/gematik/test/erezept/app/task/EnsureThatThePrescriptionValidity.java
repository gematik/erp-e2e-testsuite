...
public class EnsureThatThePrescriptionValidity implements Task {
  ...
  @Override
  @Step("{0} überprüft, dass das #deque ausgestellten E-Rezept noch #remainingDays Tage gültig ist")
  public <T extends Actor> void performAs(T actor) {
    ...
    val expectedValidityText = format("Noch {0} Tage gültig", remainingDays);
