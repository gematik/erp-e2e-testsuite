...
public enum PrescriptionDetails implements PageElement {
  ...
  PRESCRIPTION_TITLE(
          "Prescription Title", () -> null, () -> AppiumBy.accessibilityId("prsc_dtl_txt_title")
  ),
  
  PRESCRIPTION_VALIDITY_TEXT(
          "Prescription Validity Text", () -> null, () -> AppiumBy.xpath("//XCUIElementTypeStaticText[@name='prsc_dtl_txt_prescription_validity']")
  ),
  ...
  DELETE_BUTTON_TOOLBAR_ITEM(
      "Delete Prescription button", () -> null, () -> AppiumBy.xpath("//*[@label='Löschen']")),

  DELETE_PRESCRIPTION_ITEM_BUTTON(
      "Delete Prescription button", () -> null, () -> AppiumBy.xpath("//*[@name='Horizontaler Rollbalken, 1 Seite']")),
