...
public class SkipOnboardingOnAndroid implements Task {

  private final List<SwipeDirection> swipeDirections;

  @Override
  public <T extends Actor> void performAs(T actor) {
    val driverAbility = SafeAbility.getAbility(actor, UseAndroidApp.class);
    swipeDirections.forEach(driverAbility::swipe);
    driverAbility.tap(Onboarding.SKIP_BUTTON);
  }
}
