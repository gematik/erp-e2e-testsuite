...
public class IsRedeemable implements Question<Boolean> {

  @Override
  public Boolean answeredBy(Actor actor) {
    val app = SafeAbility.getAbilityThatExtends(actor, UseTheApp.class);
    app.tap(PrescriptionDetails.LEAVE_DETAILS_BUTTON);
    return actor.asksFor(IsElementAvailable.withName(Receipt.REDEEM_PRESCRIPTION_BTN));
  }

  public static IsRedeemable inMainScreen() {
    return new IsRedeemable();
  }
}
