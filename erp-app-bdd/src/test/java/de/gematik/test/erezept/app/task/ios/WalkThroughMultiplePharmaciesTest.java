...
class WalkThroughMultiplePharmaciesTest {
  ...
  void shouldWalkThroughPharmacies() {
    ...
    val walkThrough = WalkThroughMultiplePharmacies.givenFrom(pharmacyData);
    assertDoesNotThrow(() -> actor.attemptsTo(walkThrough));
  }
  ...
  void shouldWalkThroughPharmaciesWithUnexpectedOptions() {
    ...
    val walkThrough = WalkThroughMultiplePharmacies.givenFrom(pharmacyData);
    assertThrows(AssertionError.class, () -> actor.attemptsTo(walkThrough));
  }
}
