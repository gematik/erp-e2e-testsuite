...
class PrescriptionDeleteButtonTest {
  @BeforeEach
  void setUp() {
  ...
  @Test
  void shouldCheckPrescriptionButtonAvailable() {
    ...
    assertFalse(actor.asksFor(ThePrescriptionInRedemption.canNotBeDeleted("prescription")));
  }
}
