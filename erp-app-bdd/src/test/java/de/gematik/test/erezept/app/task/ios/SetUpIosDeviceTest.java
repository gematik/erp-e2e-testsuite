...
class SetUpIosDeviceTest {
  ...
  private ErpActorConfiguration createConfig(String iccsn, boolean shouldUseVeGK) {
  ...
  void shouldSetupIosDeviceWithVirtualEgk() {
    ...
    val userConfigAbility = UseAppUserConfiguration.from(createConfig(egk.getIccsn(), true));
  ...
  void shouldSetupIosDeviceWithRealEgk() {
    ...
    val userConfigAbility = UseAppUserConfiguration.from(createConfig(egk.getIccsn(), false));
    actor.can(userConfigAbility);
