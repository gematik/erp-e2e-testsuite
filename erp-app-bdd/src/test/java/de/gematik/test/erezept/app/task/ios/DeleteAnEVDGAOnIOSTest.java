...
class DeleteAnEVDGAOnIOSTest {
  ...
  @Test
  void shouldDeleteEVDGAWhichIsDeletable() {
    ...
    val deleteAnEVDGA = DeleteAnEVDGAOnIOS.fromStack(DequeStrategy.LIFO).with(EVDGAStatus.GRANTED);
  ...
  void shouldThrowPreconditionErrorOnMissingBundle() {
    ...
    val deleteAnEVDGA = DeleteAnEVDGAOnIOS.fromStack("erste").with("READY_FOR_REQUEST");
    assertThrows(MissingPreconditionError.class, () -> theAppUser.attemptsTo(deleteAnEVDGA));
  }
}
