...
public class EuConsentDeleter extends BaseRemoteCommand {

  @Override
  public void performFor(Egk egk, ErpClient erpClient) {
    log.info("Delete EU consent for {} from {}", egk.getKvnr(), this.getEnvironmentName());

    val cmd = new EuConsentDeleteCommand();
