...
public class OutputDirectoryParameter {
  ...
  public void writeFile(String filename, String content) {
    val writePath = Path.of(this.out.toAbsolutePath().toString(), filename).toFile();
  ...
  public void writeFile(String filename, String subdirectory, String content) {
    ...
    val writePath = Path.of(this.out.toAbsolutePath().toString(), subdirectory, filename).toFile();
    writeFile(writePath, content);
  }
  ...
  private void checkInit(String subdirectory) {
    val fullPath = Path.of(out.toAbsolutePath().toString(), subdirectory);
