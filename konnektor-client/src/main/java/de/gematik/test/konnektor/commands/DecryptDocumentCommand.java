...
public class DecryptDocumentCommand extends AbstractKonnektorCommand<byte[]> {
  ...
  public DecryptDocumentCommand(CardInfo cardInfo, byte[] encryptedData, Crypto algorithm) {
    this.cardInfo = cardInfo;
    this.encryptedData = encryptedData;
    this.algorithm = algorithm;
  }

  public DecryptDocumentCommand(CardInfo cardInfo, byte[] encryptedData) {
    this(cardInfo, encryptedData, Crypto.RSA_2048);
  }
