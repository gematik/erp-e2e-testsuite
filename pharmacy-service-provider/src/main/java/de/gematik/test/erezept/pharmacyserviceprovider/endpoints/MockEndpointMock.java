...
public class MockEndpointMock {
  ...
  public Response versOnly(
      ...
      byte[] body) {
    return ResponsesCheck.generateResponse(telemId, transactionId, body, rc);
  }

  @POST
  @Path("{rc}")
  public Response decodeVersOnlySecondId(
      @PathParam("rc") int rc, @QueryParam("req") String transactionId, byte[] body) {
    return ResponsesCheck.generateResponse(transactionId, body, rc);
  }
}
