...
public class RatioTypeFuzzerImpl implements FhirTypeFuzz<Ratio> {
    ...
    private void denomFuzz(Ratio r) {
        ...
        if (!r.hasDenominator()) {
            ...
            if (fuzzerContext.conditionalChance()) {
                ...
                fuzzerContext.addLog(new FuzzOperationResult<>("fuzz Denominator in Ratio", denom, newdenom));
            }
        }
    }
    ...
    private void extFuzz(Ratio r) {
        ...
        if (!r.hasExtension()) {
            ...
            fuzzerContext.addLog(new FuzzOperationResult<>("set Extension in Ratio", org.get(0).getUrl(), r.hasExtension() ? r.getExtension().get(0).getUrl() : null));
        }
    }
