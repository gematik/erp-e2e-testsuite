...
public class IdentifierFuzzerImpl implements FhirTypeFuzz<Identifier> {
  ...
  private void useFuzz(Identifier i) {
    if (!i.hasUse()) {
      ...
      val newEntry =
          (fuzzerContext.getRandomOneOfClass(
              Identifier.IdentifierUse.class, List.of(org, Identifier.IdentifierUse.NULL)));
      i.setUse(newEntry);
  ...
  private void typeFuzz(Identifier i) {
    ...
    fuzzerContext
        ...
        .ifPresent(tf -> tf.fuzz(i::hasType, i::getType, i::setType));
    fuzzerContext.addLog(
        new FuzzOperationResult<>("set Type in Identifier", org, i.hasType() ? i.getType() : null));
  }
    ...
    if (!i.hasSystem()) {
      ...
      fuzzerContext.addLog(
          new FuzzOperationResult<>(
              "Fuzz System in Identifier", org, i.hasSystem() ? i.getSystem() : null));
    }
  }
  ...
  private void valueFuzz(Identifier i) {
    ...
    if (!i.hasValue()) {
      ...
      fuzzerContext.addLog(
          new FuzzOperationResult<>(
              "fuzz Value in Identifier", org, i.hasValue() ? i.getValue() : null));
    }
  }
  ...
  private void periodFuzz(Identifier i) {
    ...
    if (!i.hasPeriod()) {
      ...
      fuzzerContext.addLog(
          new FuzzOperationResult<>(
              "fuzz Period in Identifier", org, i.hasPeriod() ? i.getPeriod() : null));
    }
  }
