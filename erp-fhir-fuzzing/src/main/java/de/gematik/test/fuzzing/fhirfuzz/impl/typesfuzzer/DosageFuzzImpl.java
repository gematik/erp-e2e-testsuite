...
public class DosageFuzzImpl implements FhirTypeFuzz<Dosage> {
    ...
    private void siteFuzzer(Dosage d) {
        ...
        fuzzerContext.getTypeFuzzerFor(CodeableConcept.class)
    ...
    private void dosePerPeriodFuzzer(Dosage d) {
        ...
        fuzzerContext.getTypeFuzzerFor(Ratio.class)
                .ifPresent(tf -> tf.fuzz(d::hasMaxDosePerPeriod, d::getMaxDosePerPeriod, d::setMaxDosePerPeriod));
    ...
    private void dosePerAdmin(Dosage d) {
        ...
        fuzzerContext.getTypeFuzzerFor(Quantity.class)
                .ifPresent(tf -> tf.fuzz(d::hasMaxDosePerAdministration, d::getMaxDosePerAdministration, d::setMaxDosePerAdministration));
    ...
    private void dosePerLife(Dosage d) {
        ...
        fuzzerContext.getTypeFuzzerFor(Quantity.class)
                .ifPresent(tf -> tf.fuzz(d::hasMaxDosePerLifetime, d::getMaxDosePerLifetime, d::setMaxDosePerLifetime));
    ...
    private void fuzzTiming(Dosage d) {
        ...
        fuzzerContext.getTypeFuzzerFor(Timing.class)
                .ifPresent(tf -> tf.fuzz(d::hasTiming, d::getTiming, d::setTiming));
        fuzzerContext.addLog(new FuzzOperationResult<>("fuzz Timing in Dosage", org, d.hasTiming() ? d.getTiming() : null));
    ...
    public Dosage generateRandom() {
        ...
        fuzzerContext.getTypeFuzzerFor(CodeableConcept.class).ifPresent(tf -> d.setAdditionalInstruction(List.of(tf.generateRandom())));
        fuzzerContext.getTypeFuzzerFor(Timing.class).ifPresent(tf -> d.setTiming(tf.generateRandom()));
        fuzzerContext.getTypeFuzzerFor(CodeableConcept.class).ifPresent(tf -> d.setSite(tf.generateRandom()));
        fuzzerContext.getTypeFuzzerFor(CodeableConcept.class).ifPresent(tf -> d.setRoute(tf.generateRandom()));
        fuzzerContext.getTypeFuzzerFor(CodeableConcept.class).ifPresent(tf -> d.setMethod(tf.generateRandom()));
        return d;
    }
