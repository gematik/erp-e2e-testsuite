...
public class StringFuzzImpl implements BaseFuzzer<String> {
  ...
  /**
   * generates a random String length that is given with lowe- and upperCase letters !!! Attention
   * !!! Method is using Faker.regexify() and could produce StackOverFlow
   *
   * <p>length of String is random 1 -> 1000;
   *
