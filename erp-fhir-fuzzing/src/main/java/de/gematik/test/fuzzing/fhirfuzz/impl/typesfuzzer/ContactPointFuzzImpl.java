...
public class ContactPointFuzzImpl implements FhirTypeFuzz<ContactPoint> {
    ...
    public ContactPoint generateRandom() {
        ...
        fuzzerContext.getTypeFuzzerFor(Period.class).ifPresent(tf -> contPoint.setPeriod(tf.generateRandom()));
        return contPoint;
    }
    ...
    private void periodFuzz(ContactPoint c) {
        ...
        fuzzerContext.getTypeFuzzerFor(Period.class).ifPresent(tf -> tf.fuzz(c::hasPeriod, c::getPeriod, c::setPeriod));
