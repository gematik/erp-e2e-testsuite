...
public class AddressFuzzerImpl implements FhirTypeFuzz<Address> {
  ...
  public Address generateRandom() {
        ...
        new Address()
            .setUse(
                fuzzerContext.getRandomOneOfClass(
                    Address.AddressUse.class, Address.AddressUse.NULL))
            .setType(
                fuzzerContext.getRandomOneOfClass(
                    Address.AddressType.class, Address.AddressType.NULL))
            ...
            .setCity(
                fuzzerContext.getStringFuzz().fuzz(fuzzerContext.getFaker().address().cityName()))
    ...
    fuzzerContext
        ...
        .ifPresent(tf -> addr.setPeriod(tf.generateRandom()));
    return addr;
  }
  ...
  private void typeFuzz(Address a) {
    if (!a.hasType()) {
      val type =
          fuzzerContext.getRandomOneOfClass(
              Address.AddressType.class, List.of(Address.AddressType.NULL));
      a.setType(type);
      ...
      val newType =
          fuzzerContext.getRandomOneOfClass(
              Address.AddressType.class, List.of(org, Address.AddressType.NULL));
      a.setType(newType);
      fuzzerContext.addLog(
          new FuzzOperationResult<>(
              "set Type in Address :", org, a.hasType() ? a.getType() : null));
    }
  }
  ...
  private void textFuzz(Address a) {
    if (!a.hasText()) {
      ...
      fuzzerContext.addLog(
          new FuzzOperationResult<>(
              "set Text in Address :", org, a.hasText() ? a.getText() : null));
    }
  }
  ...
  private void lineFuzz(Address a) {
    ...
    if (!a.hasLine()) {
      ...
      stringFuzz.fuzz(
          () -> a.getLine().get(0).toString(), o -> a.setLine(List.of(new StringType(o))));
      fuzzerContext.addLog(
          new FuzzOperationResult<>(
              "set Line in Address :", org, a.hasLine() ? a.getLine().get(0).toString() : null));
    }
  }
  ...
  private void cityFuzz(Address a) {
    if (!a.hasCity()) {
      ...
      fuzzerContext.addLog(
          new FuzzOperationResult<>(
              "set City in Address :", org, a.hasCity() ? a.getCity() : null));
    }
  }
  ...
  private void districtFuzz(Address a) {
    if (!a.hasDistrict()) {
      ...
      fuzzerContext.addLog(
          new FuzzOperationResult<>(
              "set District in Address :", org, a.hasDistrict() ? a.getDistrict() : null));
    }
  }
  ...
  private void stateFuzz(Address a) {
    if (!a.hasState()) {
      ...
      fuzzerContext.addLog(
          new FuzzOperationResult<>(
              "set State in Address :", org, a.hasState() ? a.getState() : null));
    }
  }
  ...
  private void postCodeFuzz(Address a) {
    if (!a.hasPostalCode()) {
      ...
      fuzzerContext.addLog(
          new FuzzOperationResult<>(
              "set PostCode in Address :", org, a.hasPostalCode() ? a.getPostalCode() : null));
    }
  }
  ...
  private void countryFuzz(Address a) {
    if (!a.hasCountry()) {
      ...
      fuzzerContext.addLog(
          new FuzzOperationResult<>(
              "set Country in Address :", org, a.hasCountry() ? a.getCountry() : null));
    }
  }
  ...
  private void periodFuzz(Address a) {
    ...
    if (!a.hasPeriod()) {
      ...
      fuzzerContext.addLog(
          new FuzzOperationResult<>(
              "set Period in Address :", null, a.hasPeriod() ? a.getPeriod() : null));
    } else {
      val org = a.getPeriod();
      periodFuzzer.ifPresent(tf -> tf.fuzz(a::getPeriod, a::setPeriod));
      fuzzerContext.addLog(
          new FuzzOperationResult<>(
              "set Period in Address :", org, a.hasPeriod() ? a.getPeriod() : null));
    }
  }
