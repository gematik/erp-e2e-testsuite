...
import de.gematik.test.fuzzing.fhirfuzz.MainFuzz;
import lombok.val;
...
class MainFuzzTest {
    ...
    /**
     * that Test-Call is only an Example how to use the Main.exe
     * and how to format and handed over possible Json - Configs
     */
    @Ignore
    void main() {
        ...
        val path3 = "erp-fhir-fuzzing/target/tmp/test-bundle/bundle.xml";
